...
import Comparison from "~/routes/engine/$rule/search/+components/search-result/comparison/comparison";
import CriticalWords from "~/routes/engine/$rule/search/+components/search-result/critical-words/critical-words";
import Distribution from "~/routes/engine/$rule/search/+components/search-result/distribution/distribution";
import Download from "~/routes/engine/$rule/search/+components/search-result/download/download";
import IncludePattern from "~/routes/engine/$rule/search/+components/search-result/include-pattern/include-pattern";
import MatchPattern from "~/routes/engine/$rule/search/+components/search-result/match-pattern/match-pattern";
import NextWords from "~/routes/engine/$rule/search/+components/search-result/next-words/next-words";
import PrevWords from "~/routes/engine/$rule/search/+components/search-result/prev-words/prev-words";
import Reachability from "~/routes/engine/$rule/search/+components/search-result/reachability/reachability";
import Scc from "~/routes/engine/$rule/search/+components/search-result/scc/scc";
import Statistics from "~/routes/engine/$rule/search/+components/search-result/statistics/statistics";
import MultiThreadSearch from "~/routes/engine/$rule/search/+components/search-result/strategy-search/multi-thread-search/multi-thread-search";
