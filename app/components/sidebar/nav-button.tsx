...
export default function NavButton({
  ...
  return (
    <Button
      className={cn(
        "group/nav text-muted-foreground hover:text-muted-foreground relative flex h-15 cursor-pointer flex-col gap-0 hover:bg-transparent hover:dark:bg-transparent",
