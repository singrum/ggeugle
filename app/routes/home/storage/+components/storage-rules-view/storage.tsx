...
function StorageInner() {
  ...
  return (
    <div className="md:pr-2 md:py-2 md:flex-1 h-full flex gap-2">
      <Card className="rounded-0 md:rounded-lg h-full p-0 bg-background border dark:border-0 flex-1 relative">
