  ...
  return (
    <div className="lg:bg-sidebar flex flex-col lg:h-svh min-h-dvh lg:min-h-0">
      <div className="flex-1 min-h-0 flex flex-col lg:relative ">
        <header className="shrink-0 flex items-center justify-between h-14 pl-4 lg:pl-6 pr-2 bg-sidebar border-b dark:border-0 lg:border-0 lg:dark:border-0">
        ...
        <div className="flex-1 flex min-h-auto lg:min-h-0 flex-col lg:flex-row">
          ...
          <div className="lg:pr-2 lg:pb-2 flex-1 h-full flex flex-col">
            <Card className="rounded-none lg:rounded-lg h-full p-0 bg-background lg:border lg:dark:border-0 flex-1 flex"></Card>
          </div>
        </div>
      </div>
      <MobileNav />
