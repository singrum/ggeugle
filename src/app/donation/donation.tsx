...
export default function Donation() {
  return (
    <div className="bg-sidebar h-[calc(100dvh-4rem-var(--header-height))] lg:h-[calc(100dvh-var(--header-height)-1px)]">
        ...
        <div className="mx-auto my-auto max-w-screen-md space-y-8 p-6">
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-2 text-base">
              <p>
                끝말잇기 엔진은 2022년 9월부터 저의 열정으로 직접 개발하고
                운영해 온 개인 프로젝트입니다. 광고나 유료 구독 없이, 매일 약
                150명의 사용자분들이 함께 즐겨주시는 덕분에 지금까지 이 서비스를
                이어올 수 있었습니다.
              </p>
