...
export default function Practice() {
  ...
  return (
    <div className="h-full md:h-full md:flex md:min-h-0 min-w-0 w-full">
      <div className="md:w-1/2 flex flex-col p-4  md:pt-4 md:pr-0 h-[calc(100vh-100px)] md:h-full md:max-w-screen-sm">
